...
import net.blueva.arcade.modules.lucky_pillars.support.loot.TrackedChest;
...
public class ArenaState {
    ...
    public void setSelectedModifier(String selectedModifier) {
    ...
    public void setNextBlockDropAtMillis(long nextBlockDropAtMillis) {
        this.nextBlockDropAtMillis = nextBlockDropAtMillis;
    }

    public int getSecondsUntilNextBlockDrop() {
        if (nextBlockDropAtMillis < 0L) {
            return -1;
        }

        long millisRemaining = nextBlockDropAtMillis - System.currentTimeMillis();
