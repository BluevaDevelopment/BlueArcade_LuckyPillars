package net.blueva.arcade.modules.lucky_pillars.support.spawn;
...
public class SpawnCageService {
    ...
    private String getCageCategoryId() {
        return moduleConfig.getStringFrom("store.yml", "category_settings.cages.id", "lucky_pillars_cages");
    }
