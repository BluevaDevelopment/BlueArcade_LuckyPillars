package net.blueva.arcade.modules.lucky_pillars.support.store;
...
public class LuckyPillarsStoreService {

    private final ModuleConfigAPI moduleConfig;
    private final StoreAPI storeAPI;
    private final ModuleInfo moduleInfo;

    public LuckyPillarsStoreService(ModuleConfigAPI moduleConfig, StoreAPI storeAPI, ModuleInfo moduleInfo) {
