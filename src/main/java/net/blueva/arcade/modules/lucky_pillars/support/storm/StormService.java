package net.blueva.arcade.modules.lucky_pillars.support.storm;
...
public class StormService {
    ...
    public StormService(ModuleInfo moduleInfo, ModuleConfigAPI moduleConfig, StatsAPI statsAPI, LuckyPillarsGame game) {
