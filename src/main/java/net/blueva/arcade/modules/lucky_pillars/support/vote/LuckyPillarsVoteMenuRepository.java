...
public class LuckyPillarsVoteMenuRepository {

    private final ModuleConfigAPI moduleConfig;
    private final Map<String, MenuDefinition<Material>> menus = new HashMap<>();

    public LuckyPillarsVoteMenuRepository(ModuleConfigAPI moduleConfig) {
        this.moduleConfig = moduleConfig;
    }

    public void loadMenus() {
        menus.clear();
        loadMenu(LuckyPillarsVoteService.MENU_MODIFIERS, "menus/java/lucky_pillars_vote_modifiers.yml",
                "menus/bedrock/lucky_pillars_vote_modifiers.yml");
    }
